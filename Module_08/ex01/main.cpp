...
/*   Updated: 2022/03/27 11:48:17 by twagner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	// TEST 2
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Span copy from another one ]--- \033[0m" << std::endl;
	Span sp9(sp);
	...
	// TEST 6
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Try to get longestSpan on an empty sized span ]--- \033[0m" << std::endl;
	Span sp2(0);
	try
	{
	...
	catch(const std::exception &e)
	{
 	...
 	// TEST 7
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Try to add a number in an empty sized span ]--- \033[0m" << std::endl;
	try
	{
		sp2.addNumber(6);
	}
	...
	// TEST 8
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Try to get shortest span in a 1 number span ]--- \033[0m" << std::endl;
	Span	sp7(1);
	sp7.addNumber(6);
	try
	{
	...
	// TEST 9
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Try to get longest span in a 1 number span ]--- \033[0m" << std::endl;
	try
	{
	...
	// TEST 12
	std::cout << std::endl;
	std::cout << "\033[1;35m ---[ Inserting 100000 values using 1 command ]--- \033[0m" << std::endl;
	Span				sp5(100000);
